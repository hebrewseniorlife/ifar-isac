...
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**Manual of Procedures**  |:Develop MOP; test procedures 	|:Update and track changes    |:Archive                          |
|                          |:                               |:throughout trial; maintain  |:                                 | 
|                          |:                               |:version control	          |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**Statistical Analysis**  |:Review SAP; generate signoff   |:Update and track changes    |:Archive                          |
|**Plan Statistical**      |:by relevant parties            |:throughout trial; maintain  |:                                 | 
|** Analytic Protocol**    |: 	                            |:version control	          |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**Data Safety and**       |:Author charter; recruit DSMB   |:Circulate open and closed   |:Archive                          |
|**Monitoring Documents**  |:members, assign chairpersonship|:session reports at          |:                                 |
|                          |:in partnership with funders	  |:previously agreed upon    |:                                 |
|                          |:                               |:interval prior to meetings. |:                                 |
|                          |:                               |:Submit to relevant          |:                                 | 
|                          |:                               |:authorities (e.g. DSMB, IRB,|:                                 | 
|                          |:                               |:funding agencies)	          |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**DSMB Report** 	       |:Develop template report;       |:Update and track changes    |:Develop and disseminate final    |
|                          |:obtain relevant approvals	    |:throughout trial; maintain  |:DSMB report; Archive             |
|                          |:                               |:version control	          |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**Meeting Templates**     |:Design meeting templates       |:Co-author and maintain      |:                                 |
|                          |:(agendas and minutes)	        |:meeting records; disseminate|:                                 |
|                          |:                               |:key information             |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**Tracking / Monitoring** |:Develop tracking and monitoring|:Maintain record of findings |:                                 | 
|**Reports**               |:templates for enrollment, study|:as motivation for process   |:                                 |
|                          |:visit attendance, protocol     |:improvement, changes to     |:                                 |
|                          |:adherence, etc.	            |:procedures and protocol     |:                                 |
|                          |:                               |:amendments                  |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**Data Quality Reports**  |:Develop reporting of data      |:Maintain record of findings |:                                 |
|                          |:completeness and quality	    |:as motivation for process   |:                                 |
|                          |:                               |:improvement, changes to     |:                                 |
|                          |:                               |:procedures and protocol     |:                                 |
|                          |:                               |:amendments                  |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|**Additional**            |:Develop study logs,            |:Update and track changes    |:Maintain and archive record of   |
|**Documentation**         |:documentation of adverse       |:throughout trial; maintain  |:all relevant reporting           |
|                          |:events, tracking of participant|:version control             |:                                 |
|                          |:disposition, IRB submissions   |:                            |:                                 |
|                          |:and approvals, etc.	        |: 	                          |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
