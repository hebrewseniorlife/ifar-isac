...
reports, publication and archiving **(Figure X.X**). Investigators
...
*Figure X.X Simplified temporal overview of the management process for
...
*Figure X.1. Example flowchart depicting high-level summary of Pretrial
...
*Figure X.2. Example flowchart depicting high-level summary of trial
activities *

## Management of trial documentation (see Essential documents module)

*Table X.1 Project management activities relevant for trial
documentation*
...
*Table X.3 Example of a schedule specific to protocol development*
...
along the critical path. These concepts are illustrated in Figure X.3.

*Figure X.3. The project critical path is outline in orange; any delays
along this path imply an elongation of the total project duration. *

Management of internal and external communications {#management-of-internal-and-external-communications .ListParagraph}
...
*Table X.7 Site Management Plan during the different phases of the
Clinical Trial*
