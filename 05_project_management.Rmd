...
|Trial Document / Activity |: Project Management Activities, by Phase                                                        |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|		                       |:Pre-trial                      |:Execution	                  |:Closeout                         |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|Regulatory Binder         |:Set up; establish location for |:Review/update and document  |:Complete and archive regulatory  |
|                          |:storage and security	          |: changes on key trial       |:binder                           |
|                          |:                               |: documents	                |:                                 |
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|Protocol 	               |:Review and approval by relevant|:Manage and document protocol|:Archive all relevant             |
|                          |:parties                        |:amendments; obtain relevant |:documentation ; submit to        |  
|                          |:                               |:approvals	                  |:relevant authorities as necessary|
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|Credentials and           |:Gather research team           |:Maintain study roster,      |:Archive                          |
|competencies              |:documentation (i.e., resumes,  |:record of competencies, and |:                                 |
|                          |:conflict of interest forms,    |:responsibilities chart      |:                                 |
|                          |:evidence of completion of      |:                            |:                                 |
|                          |:required certifications)	      |:                            |:                                 | 
|--------------------------|:-------------------------------|:----------------------------|:---------------------------------|
|Investigator Brochure /   |:Develop marketing materials/   |:Manage and document updates;|:                                 |
|Marketing	               |:investigators brochure	        |:obtain relevant approvals	  |:                                 |
...
Statistical Analytic Protocol	Review SAP; generate signoff by relevant parties	Update and track changes throughout trial; maintain version control	Archive
...
DSMB Report 	Develop template report; obtain relevant approvals	Update and track changes throughout trial; maintain version control	Develop and disseminate final DSMB report; Archive
...
Tracking / 
Monitoring Reports 	Develop tracking and monitoring templates for enrollment, study visit attendance, protocol adherence, etc.	Maintain record of findings as motivation for process improvement, changes to procedures and protocol amendments	--
...
documentation*
  ...
  Regulatory Binder)                     Set up; establish location for storage and security                                                             

  Protocol                               Review and approval by relevant parties

  Credentials and competencies           Gather research team documentation (i.e., resumes, conflict of interest forms, evidence of completion of required certifications)

  Investigator Brochure / Marketing      Develop marketing materials/ investigators brochure

  Manual of Procedures                   Develop MOP; test procedures

  Statistical Analysis Plan              Review SAP; generate signoff by relevant parties
                                         
  Statistical Analytic Protocol          

  Data Safety and Monitoring Documents   Author charter; recruit DSMB members, assign chairpersonship in partnership with funders

  DSMB Report                            Develop template report; obtain relevant approvals

  Meeting Templates                      Design meeting templates (agendas and minutes)

  Tracking /                             Develop tracking and monitoring templates for enrollment, study visit attendance, protocol adherence, etc.
                                         
  Monitoring Reports                     

  Data Quality Reports                   Develop reporting of data completeness and quality

  Additional Documentation               Develop study logs, documentation of adverse events, tracking of participant disposition, IRB submissions and approvals, etc.
  --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
*Table 5.3 Example of a schedule specific to protocol development*
  ...
  ---------------------------------------------------------------------------------------------------------------------------
  **Activity Code**   **Activity/ Deliverable**                               **Duration**   **Predecessor / Prerequisite**
