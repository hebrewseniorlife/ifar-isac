...
author: "The Interventional Studies in Aging Center (ISAC) at the Institute for Aging Research (IFAR)"
documentclass: book
link-citations: yes
...
1.  **Good Clinical Practice (GCP)** is an international quality
    ...
    Clinical Practice**](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-16-148.html#_ftn2_)
...
2.  **Harvard Catalyst** [**Clinical Trial Design**](https://catalyst.harvard.edu/services/ctd/) is
...
3.  **NIH Clinical Research** [**Training On-Line course**](http://crt.nihtraining.com) is available
