...
1.  **Good Clinical Practice (GCP)** is an international quality
    ...
    Clinical Practice**](<http://grants.nih.gov/grants/guide/notice-files/NOT-OD-16-148.html#_ftn2>)
    ...
    clinical trials. The [**FDA**](<https://gcplearningcenter.niaid.nih.gov/Pages/default.aspx>) has a similar requirement.**
    ...
    National Drug Abuse Treatment Clinical Trails Network [**Good Clinical Practice (GCP) Course**](https://gcp.nihtraining.com/)

    [**Online GCP**](http://www.onlinegcp.us/)

    Collaborative Institutional Training Initiative (CITI) [**Good clinical Practice (GCP) Course**](https://www.citiprogram.org/index.cfm?pageID=90)

2.  **Harvard Catalyst Clinical Trial Design:** **[**Clinical Trial Design**](https://catalyst.harvard.edu/services/ctd/)** is
...
4.  **Barnett International: Design and Conduct of Clinical Trials:
    ...
    On-site **[**two-day course**](http://www.barnettinternational.com/Live-Seminars/Design-and-Conduct-of-Clinical-Trials--Design-Requirements,-Statistical-Issues,-and-Clinical-Protocols/)** that provides an introduction to the
...
[https://grants.nih.gov/grants/guide/notice-files/NOT-OD-15-015.html](https://grants.nih.gov/grants/guide/notice-files/NOT-OD-15-015.html)
